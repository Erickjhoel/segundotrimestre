...
public class FXMLControllermenu implements Initializable {
    ...
    public void handleEscena1(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/fxml/FXMLLoguin.fxml"));
        anchor = loader.load();
    ...
    public void handleEscena2(ActionEvent event) throws IOException {
        ...
        //load up OTHER FXML document
        FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/fxml/FXMLAdministrador.fxml"));
        anchor = loader.load();
        FXMLControllerAdministrador controller = loader.getController();
        controller.setController(this);
        fxRoot.setCenter(anchor);
    ...
    @FXML
    public void handleEscena3(ActionEvent event) throws IOException {
        AnchorPane anchor;
        //load up OTHER FXML document
        FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/fxml/FXMLReponedor.fxml"));
        anchor = loader.load();
