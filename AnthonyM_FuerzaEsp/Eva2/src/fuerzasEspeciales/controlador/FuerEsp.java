...
@XmlRootElement(name = "FuerzaEspecial")
public class FuerEsp {
    ...
    @XmlElements({
        ...
        ,
    @XmlElement(name = "MisionCombate", type = MisionCombate.class)
    })
    ...
    public FuerEsp() {
        ...
        recursos.add(e3);
        recursos.add(f3);
        Mision ete = new Mision(LocalDate.MIN,"ete","juanpepe", 8);
        misiones.put(ete.getNombre(), ete);
        MisionCombate ete22= new MisionCombate(LocalDate.MIN,"ete2","jacintoJose", 5, 1);
        misiones.put(ete22.getNombre(), ete);
    }
